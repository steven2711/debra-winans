  ...
  return (
    <section className={styles.bookDisplay}>
      ...
      <div className={styles.info}>
        ...
        <div>
          <p>
            Nothing can inspire us more than a human story with which we can all
            relate; a story that encourages us to believe in our own dreams and
            to have faith in the promises of God who sometimes seems far away.
            Life Altered Not Over! addresses the reality of pain and provides
            essential tool for hurting individuals. People in any type of
            emotional, mental and spiritual pain are looking for
            “how-to-get-healed tools. This life changing book provides just
        ...
        <div className={styles.btns}>
          <Button
            text="order now"
            link={true}
            path="https://checkout.square.site/merchant/MLH6RXNFN7NQ5/checkout/JQS4HKDONCUF26QAPOTTIUES"
          />
          {display ? (
            <Button
